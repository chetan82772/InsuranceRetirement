...
public class RetirementPlan {
    ...
    @DecimalMin(value = "500.0", message = "Minimum investment is ₹500")
    @DecimalMax(value = "1000000.0", message = "Maximum investment allowed is ₹10,00,000")
    private Double monthlyInvestment;
    
    @Positive
    @NotNull(message = "Expected return is required")
    @DecimalMin(value = "1.0", message = "Expected return must be at least 1%")
    @DecimalMax(value = "30.0", message = "Expected return cannot exceed 30%")
    private Double expectedReturn;
    
    @Positive
    @NotNull(message = "Years to retirement is required")
    @Min(value = 1, message = "Years to retirement must be at least 1")
    @Max(value = 50, message = "Years to retirement cannot exceed 50")
    ...
    public void setEstimatedCorpusFormatted(String estimatedCorpusFormatted) {
        this.estimatedCorpusFormatted = estimatedCorpusFormatted;
    }
}